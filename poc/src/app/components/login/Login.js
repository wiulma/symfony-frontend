...
*/
    const [passwordView, setPasswordView] = useState({passwordView: false});
                ...
                <form onSubmit={this.handleLogin.bind(this)} >  
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-group col-sm-12 icon">
                            ...
                            <span onClick={this.togglePwd.bind(this)}><FontAwesomeIcon icon={pwdLayout[passwordView].icon} size="2x"/></span>
                        </div>           
                    </div>
