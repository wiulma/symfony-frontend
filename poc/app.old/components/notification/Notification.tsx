...
export class NotificationAlert extends React.PureComponent<{}, NotificationStateData> {

  private ALERT_VISIBLE_TIMEOUT: number = 10;
  ...
  showMessage(detail: NotificationTypeMessage) {
